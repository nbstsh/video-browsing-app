...
var VIDEO_BOX_ELEMENT_ID = 'video-box';
var SOURCE_ELEMENT_ID = 'source'; // TODO : set width and height of video element
...
function () {
  ...
  _createClass(VideoManager, [{
    ...
    key: "resetVideoBox",
    value: function resetVideoBox() {
      var videoBoxEl = document.getElementById(VIDEO_BOX_ELEMENT_ID);
    ...
    key: "initGoogleDirveVideo",
    value: function initGoogleDirveVideo() {
      var src = "https://drive.google.com/uc?export=download&id=".concat(this.videoId);
    ...
    key: "implementCurrentTypeVideo",
    value: function implementCurrentTypeVideo() {
...
document.querySelectorAll('[data-video-id][data-type]').forEach(function (el) {
...
function findCurrentElement() {
  ...
  var currentTime = Number(moment__WEBPACK_IMPORTED_MODULE_0___default()().format('HHmm'));
  console.log(currentTime);
  var dayEls = document.querySelector('.program__week').childNodes;
  var targetDayEl;
...
function renderCurrentVideo() {
  var currentEl = findCurrentElement();
